...
OPTIONS = {
    ...
    "packages": ["akm", "rumps", "uvicorn", "fastapi", "httpx", "click", "cryptography", "PIL", "anyio", "sqlite_vec", "jieba"],
    "includes": ["akm.server", "akm.db", "akm.key_pool", "akm.proxy", "akm.audit", "akm.models", "akm.config", "akm.agent", "akm.adapter", "akm.cli", "markdown_chunker", "sqlite_vec", "jieba", "_cffi_backend"],
