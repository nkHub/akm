  ...
  class AkmChatViewer extends HTMLElement {
    constructor() {
      ...
      this._root.innerHTML = [
        ...
        '.md p{margin:0 0 6px 0;}.md p:last-child{margin-bottom:0;}',
        '.md h1,.md h2,.md h3,.md h4,.md h5,.md h6{margin:0 0 6px 0;font-weight:600;line-height:1.4;}',
        '.md h1,.md h2{font-size:1.15em;}',
        '.md h3,.md h4{font-size:1.08em;}',
        '.md h5,.md h6{font-size:1em;}',
        '.md ul,.md ol{margin:0 0 6px 0;padding-left:20px;}',
        '.md li{margin:0 0 2px 0;}',
        '.md pre{white-space:pre-wrap;background:rgba(0,0,0,.35);border:1px solid rgba(99,102,241,.25);border-radius:8px;padding:8px 10px;margin:0 0 6px 0;}',
        '.md code{background:rgba(99,102,241,.16);padding:1px 4px;border-radius:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.92em;}',
        '.md pre code{background:transparent;padding:0;font-size:inherit;border-radius:0;}',
        '.md blockquote{margin:0 0 6px 0;padding:2px 10px;border-left:3px solid rgba(99,102,241,.4);color:#9ca3af;}',
        '.md a{color:#818cf8;}',
        '.md img{max-width:100%;border-radius:6px;}',
        '.md table{border-collapse:collapse;margin:0 0 6px 0;}',
        '.md th,.md td{border:1px solid rgba(99,102,241,.25);padding:4px 8px;font-size:.95em;}',
