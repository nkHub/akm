  ...
  class AkmJsonViewer extends HTMLElement {
    constructor() {
      ...
      this._root.innerHTML = [
        '<style>',
        ':host{display:block;width:100%;min-height:20px;overflow:visible;font-size:12px;line-height:1.5;color:#d1d5db;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace;tab-size:2;}',
        ...
        '.box{white-space:pre-wrap;word-break:break-all;} pre{white-space:pre-wrap;word-break:break-all;margin:0;tab-size:2;} .err{color:#fca5a5;} .link{color:#93c5fd;text-decoration:underline;cursor:pointer;}',
        '</style>',
